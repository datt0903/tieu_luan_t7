...
# Import từ api/v1
from app.api.v1 import issues, projects, auth, comments, attachments, activity_logs, issue_labels, labels
...
app.include_router(issue_labels.router, prefix="/api/v1", tags=["issue_labels"])
